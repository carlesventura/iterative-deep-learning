    ...
    if breadth_first_search: #old implementation
        ...
        for ii in range(0,5):
            ...
            for jj in range(0,len(center_points)):
                ...
                confident_connections = get_most_confident_outputs(img_idx, center_points[jj][1], center_points[jj][0], confident_th, gpu_id, connected_same_vessel)
        ...
        if connected_same_vessel:
            scipy.misc.imsave('/scratch_net/boxy/carlesv/results/DRIVE/Results_iterative_graph_creation_no_mask_offset_th_25_same_vessel/pred_graph_%02d_mask_graph.png' % img_idx, mask_graph)
        else:
            ...
            #scipy.misc.imsave('/scratch_net/boxy/carlesv/results/DRIVE/Results_iterative_graph_creation_th_25/pred_graph_%02d_mask_graph.png' % img_idx, mask_graph)
            #scipy.misc.imsave('/scratch_net/boxy/carlesv/results/DRIVE/Results_iterative_graph_creation_no_mask_offset_th_25/pred_graph_%02d_mask_graph_offset_2.png' % img_idx, mask_graph)
            scipy.misc.imsave('/scratch_net/boxy/carlesv/results/DRIVE/Results_iterative_graph_creation_no_mask_offset_th_25/pred_graph_%02d_mask_same_mask_graph.png' % img_idx, mask_graph)
