...
def get_most_confident_outputs_vessel_width(img_id, patch_center_row, patch_center_col, confident_th, gpu_id, connected_same_vessel):
    ...
    if x_tmp > 0 and y_tmp > 0 and x_tmp+patch_size < w and y_tmp+patch_size < h:
        ...
        results_dir_vessels = './results_dir_vessels/results_DRIU_vessel_segmentation/'
...
for img_idx in range(1,21):
    ...
    if connected_same_vessel:
        scipy.misc.imsave('./results_dir_vessels/results_iterative_graph_creation_no_mask_offset_th_25_same_vessel/pred_graph_%02d_mask_graph.png' % img_idx, mask_graph)
    else:
        scipy.misc.imsave('/results_dir_vessels/results_iterative_graph_creation_no_mask_offset_th_25/pred_graph_%02d_mask_graph.png' % img_idx, mask_graph)
