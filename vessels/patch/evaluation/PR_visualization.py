...
if not connected:
    output_file = './results_dir_vessels/PR_SGH_from_DRIU.npz'
else:
    if from_same_vessel:
        if bifurcations_allowed:
            output_file = './results_dir_vessels/PR_SGH_from_DRIU_connected_same_vessel.npz'
        else:
            output_file = './results_dir_vessels/PR_SGH_from_DRIU_connected_same_vessel_wo_bifurcations.npz'
    else:
        output_file = './results_dir_vessels/PR_SGH_from_DRIU_results_connected.npz'
